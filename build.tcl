...
#num path can tell all paths that are contributing to negative slack when synthesizing
...
if {[get_property SLACK [get_timing_paths -max_paths 5 -nworst 5 -setup]] < 0} {
